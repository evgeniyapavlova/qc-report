<script>
  ...
  const content = {
    ru: {
      ...
      quote:'Мы уже лидируем на рынке опционов,  и cледующим продуктом,  в котором мы хотели развиваться, стал Forex. Это продукт с очень большим потенциалом.',
      plan:'Планирование',
      planText:'При планировании релиза Margin Forex на пользователей мы обращали особое внимание на три аспекта:',
  ...
  const tags = ['Software Development',
'IT Operations',
'Data & Analysis',
'Quality Control',
...
<section>
  <Layout>
    ...
    <div class="release">
      ...
      <div class="mockup">
        <img src="/assets/margin_forex/margin_mockup.jpg" alt="" />
      </div>
    </div>
    <Release lang="{lang}" />
    <Reviews lang="{lang}" />
