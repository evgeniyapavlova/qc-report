...
import Chart from '../../Chart.svelte';
  ...
  const content = {
	  ru: {h2: 'Поддержка клиентов: новые страны, новые продукты', desc:'Увеличение количества активных пользователей повлияло и на работу департамента клиентского сервиса. В этом году мы ставили новые рекорды по количеству обработанных обращений клиентов в чатах, на электронной почте, горячей линии, а также активно нанимали удаленных сотрудников, чтобы сохранить качество услуг при возросшей нагрузке. На протяжении года мы поддерживали высокий уровень удовлетворенности сотрудников.', records:'Наши рекорды', recordsText:'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using ', quote:'На протяжении года мы поддерживали высокий уровень удовлетворенности сотрудников'},
...
const chartData = {
  ...
  const itemsIcon = [
    { icon: emailsIcon, period:'239 846 <span>2019</span>', number: '736 786', caption: 'Emails' },
    { icon: chatsIcon, period:'1 909 847 <span>2019</span>',number: '3 641 110', caption: 'Chats' },
    { icon: callsIcon, period:'166 <span>2019</span>',number: lang==='ru'?'238 дней': '238 days', caption: 'Talk time' },
  ];
</script>
