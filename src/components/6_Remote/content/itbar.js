  ...
  ru: {
    ...
    items2: [
      ...
      },
      {
        ...
        text:
          'В считанные дни закупили принтеры и сканеры для сотрудников административной ветки, которые занимаются документооборотом. Всей командой, в конвейерном режиме, настраивали и проверяли их, чтобы у сотрудников не было проблем с подключением их дома.',
      },
      {
